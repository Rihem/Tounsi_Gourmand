 ...
 */
public class AjoutProprietaire extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(email.indexOf("@")==-1) {
            ...
            if("".equals(err)){
                ...
                Prop.setTel(tel);
                Prop.setSexe(sexe);
                  ProprietaireDAO PRdao =new ProprietaireDAO ();
                PRdao.ajouter(Prop);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutProprietaire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjoutProprietaire().setVisible(true);
            }
        });
    }
